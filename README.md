## people (noetic) - 1.4.2-1

The packages in the `people` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic people` on `Thu, 07 Oct 2021 20:58:31 -0000`
...
## people (noetic) - 1.4.0-1

The packages in the `people` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic people -y -e` on `Sat, 20 Feb 2021 04:36:21 -0000`
